...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    try {
      ...
      console.error("[denton/lookup] Neighborhood stats error:", err);
    }

    // Format comps — Denton has no beds/baths data
    ...
    console.error("[denton/lookup] Error:", error);
