...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    // Remove common Collin County city suffixes like ", PLANO, TX 75023" or ", FRISCO TX"
    cleaned = cleaned.replace(/,?\s*(PLANO|FRISCO|MCKINNEY|ALLEN|WYLIE|ANNA|CELINA|PROSPER|MURPHY|SACHSE|LUCAS|LAVON|PRINCETON|FARMERSVILLE|FAIRVIEW|PARKER|JOSEPHINE|MELISSA|BLUE RIDGE|LOWRY CROSSING|COPEVILLE|WESTON|WESTMINSTER|NEW HOPE|NEVADA)\b.*$/i, "");
    ...
    console.error("[collin/autocomplete] Error:", error);
