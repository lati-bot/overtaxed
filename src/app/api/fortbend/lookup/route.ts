...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    // Fort Bend container is partitioned by neighborhood_code, so we need cross-partition query
    ...
    try {
      ...
      console.error("[fortbend/lookup] Neighborhood stats error:", err);
    }
    ...
    return NextResponse.json({
      found: true,
      jurisdiction: "fortbend_county_tx",
      property: {
        acct: prop.acct,
    ...
    console.error("[fortbend/lookup] Error:", error);
