...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    // Remove common Bexar County city suffixes
    cleaned = cleaned.replace(/,?\s*(SAN ANTONIO|CONVERSE|HELOTES|VON ORMY|BOERNE|UNIVERSAL CITY|LIVE OAK|ELMENDORF|SAINT HEDWIG|ATASCOSA|KIRBY|SELMA|ALAMO HEIGHTS|LEON VALLEY|ADKINS|TERRELL HILLS|HILL COUNTRY VILLAGE|SHAVANO PARK|SCHERTZ|OLMOS PARK|WINDCREST|BALCONES HEIGHTS|CASTLE HILLS|CHINA GROVE|SANDY OAKS|SOMERSET|LYTLE|MACDONA|BEXAR)\b.*$/i, "");
    ...
    console.error("[bexar/autocomplete] Error:", error);
