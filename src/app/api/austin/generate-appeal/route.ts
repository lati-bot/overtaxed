...
async function sendAustinEmail(
  ...
  await getResend().emails.send({
    ...
    to: email,
    subject: `Property Tax Protest Package — ${data.address} — Travis County`,
    html: `
      <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; max-width: 600px; margin: 0 auto; color: #1a1a2e;">
        ...
        <p style="color: #666; margin-bottom: 24px; font-size: 15px;">Everything you need to protest your property tax for <strong>${data.address}</strong> with the Travis Central Appraisal District.</p>
