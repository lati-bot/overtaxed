          ...
          <div className="flex flex-col sm:flex-row gap-3">
            <div className="relative flex-1">
              <input
                ...
                className="w-full h-14 px-5 rounded-xl text-base bg-[#f7f6f3] border border-black/[0.06] text-[#1a1a1a] placeholder-[#aaa] focus:border-[#6a5490]/30 focus:outline-none focus:ring-2 focus:ring-[#6a5490]/10 transition-all"
                value={address}
            ...
            <button
              ...
              className="h-14 px-8 rounded-xl font-medium text-base transition-all disabled:opacity-40 bg-[#6a5490] text-white hover:bg-[#574479] shadow-lg shadow-[#6a5490]/20 whitespace-nowrap"
            >
            ...
            <>
              ...
              <form onSubmit={handleNotifySubmit} className="flex gap-2">
                <input type="email" placeholder="you@email.com" value={notifyEmail} onChange={(e: React.ChangeEvent<HTMLInputElement>) => setNotifyEmail(e.target.value)} required
                  className="flex-1 h-11 px-4 rounded-xl text-sm bg-[#f7f6f3] border border-black/[0.06] text-[#1a1a1a] placeholder-[#aaa] focus:outline-none focus:ring-2 focus:ring-[#6a5490]/10"
                />
                <button type="submit" disabled={notifyLoading} className="h-11 px-5 rounded-xl text-sm font-medium bg-[#6a5490] text-white hover:bg-[#574479] transition-colors disabled:opacity-50">
      ...
      <nav className="sticky top-0 z-50 bg-[#f7f6f3]/90 backdrop-blur-xl border-b border-black/[0.04]">
        <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="text-xl tracking-[-0.02em] font-medium text-[#1a1a1a] flex items-center gap-2">
            <span className="w-2.5 h-2.5 rounded-[3px] bg-[#6a5490]" />
            overtaxed
          </div>
          <div className="flex items-center gap-8">
            ...
            <button 
              ...
              className="hidden sm:block px-5 py-2.5 rounded-full text-[13px] font-medium bg-[#6a5490] text-white hover:bg-[#574479] transition-colors"
            >
              Check My Address
            </button>
          </div>
      ...
      <section className="pt-16 sm:pt-24 pb-6 sm:pb-8 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="mt-5 flex flex-wrap items-center justify-center gap-x-3 gap-y-1 text-[13px] text-[#999]">
            <span className="w-1.5 h-1.5 rounded-full bg-[#6a5490] inline-block" />
            <span>DFW</span>
          ...
          <div className="rounded-3xl p-8 sm:p-12 bg-white border border-black/[0.06] shadow-sm">
            <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-6 mb-8">
              ...
              <button 
                ...
                className="h-14 px-8 rounded-2xl font-medium text-base bg-[#6a5490] text-white hover:bg-[#574479] shadow-lg shadow-[#6a5490]/20 transition-colors"
              >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {[
                  ...
                  <div key={item} className="flex items-start gap-3">
                    <div className="w-1.5 h-1.5 rounded-full bg-[#6a5490] mt-2 flex-shrink-0" />
